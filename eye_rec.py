...
face_cascade = cv2.CascadeClassifier('C:/Users/SAMYAK/Desktop/Eye recognition/haarcascade_frontalface_default.xml')
eye_cascade = cv2.CascadeClassifier('C:/Users/SAMYAK/Desktop/Eye recognition/haarcascade_eye.xml')
...
img = cv2.imread('C:/Users/SAMYAK/Desktop/Eye recognition/image.jpg')
...
cv2.waitKey(0)
cv2.imwrite('savedimage.jpeg', resized)    
